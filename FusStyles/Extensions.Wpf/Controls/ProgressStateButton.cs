...
namespace Ws.Extensions.UI.Wpf.Controls
{
    public class ProgressStateButton : Button, INotifyPropertyChanged
    {
        ...
        public string CurrentCaption { get { return ProgressStates?[CurrentProgressState].Caption; } }

        public Geometry CurrentIcon { get { return ProgressStates?[CurrentProgressState].Icon; } }
