...
namespace TestDrawing
{
    public static class Matrix3DExtension
    {
        ...
        public static bool IsEqualWithDelta(this Matrix3D matrix1, Matrix3D matrix2, double delta)
        {
        ...
        public static bool IsEqualRotationWithDelta(this Matrix3D matrix1, Matrix3D matrix2, double delta)
        {
            if (matrix1.IsIdentity && matrix2.IsIdentity)
                return true;
        ...
        public static bool IsEqualTranslationWithDelta(this Matrix3D matrix1, Matrix3D matrix2, double delta)
        {
            if (matrix1.IsIdentity && matrix2.IsIdentity)
                return true;
